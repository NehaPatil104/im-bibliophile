...
<div class="sidenav">
	...
	<div class="form-deco">
		...
		<form action="userServlet" method="get">
			  <input type="hidden" name="command" value="UPDATEWISHBOOK">
			  <input type="hidden" name="wishusername" value="${username}">
			  <label for="bname">Book Name</label><br>
			  <input type="text" id="bname" name="bookname" value="${WISH_BOOKS.bookname }"><br><br>
			  <label for="descript" class="label-input">Description</label><br>
			  <textarea id="descript" name="description" >${WISH_BOOKS.description }</textarea><br><br>
			  <label class="label-input">Progress</label><br>
				  <select name="progress" style="width:50%;padding: 12px 20px;margin: 8px 0;border: 2px solid #49C9AF;border-radius: 4px;outline:none;" >
				    <option value="${WISH_BOOKS.progress}">${WISH_BOOKS.progress}</option>
			  ...
			  <input type="date" id="dat" name="date" min="1900-01-01" max="2099-01-01" value="${WISH_BOOKS.date}"><br><br>
