...
<div class="sidenav">
	...
	<div class="form-deco">
		...
		<form action="userServlet" method="get">
			  ...
			  <input type="text" id="bname" name="bookname" value="${USER_BOOKS.bookname}"><br><br>
			  
			  <label for="lname">Author</label><br>
			  <input type="text" id="lname" name="author" value="${USER_BOOKS.author}"><br><br>
			  
			  <label for="dat">Date</label><br>
			  <input type="date" id="dat" name="date" min="1900-01-01" max="2099-01-01" value="${USER_BOOKS.date}"><br><br>
			  
			  <label for="review">Review</label><br>
			  <textarea id="review" name="review">${USER_BOOKS.review}</textarea><br><br>
